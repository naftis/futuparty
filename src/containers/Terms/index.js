      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.paragraph}>
            ...
            {'Conditions")'} carefully before using the Futufinlandia mobile
            application and futurice.party site (the {'"Service"'}) operated by
            Futurice Oy ({'"us", "we", or "our"'}).
          </Text>
          <Text style={styles.paragraph}>
          ...
          <Text style={styles.paragraph}>
            <Text style={styles.bold}>Contest rules</Text>
          </Text>
          <Text style={styles.paragraph}>
            Futurice Oy (collectively, the “Company”), will conduct its contests
            substantially as described in these general contesting rules, and by
            participating, each participant agrees as follows:
          </Text>
          <Text style={styles.paragraph}>
            Apple is not a sponsor or involved in the contest in any manner.
          </Text>
          <Text style={styles.paragraph}>
            Eligibility and Limitations. Participants and winner(s) must be
            equal or over 18 years old.
          </Text>
          <Text style={styles.paragraph}>
            Prize. The prize that may be awarded to the eligible winner are not
            transferable, redeemable for cash or exchangeable for any other
            prize. All prizes must be redeemed from the Company within thirty
            (30) days of the contest end date unless otherwise stated in the
            contest’s official rules. If a winner cannot be contacted or is
            disqualified for any reason, the Company reserves the right to
            determine an alternate winner or not to award that winner’s prize,
            in its sole discretion.{' '}
          </Text>
          <Text style={styles.paragraph}>
            Consumer Created Content. If the entry for the contest includes any
            creative material from the participant, including but not limited
            to, consumer created content, by submitting your entry: (1) you
            agree that your disclosure is gratuitous, unsolicited and without
            restriction and will not place the company or contest sponsors under
            any fiduciary or other obligation, that the company is free to
            disclose the ideas on a non-confidential basis to anyone or
            otherwise use the ideas without any additional compensation to you;
            (2) you acknowledge that, by acceptance of your submission, the
            company and contest sponsors do not waive any rights to use similar
            or related ideas previously known to sponsor, or developed by their
            employees, or obtained from sources other than you; (3) you are
            verifying that you are the owner and producer of the submitted
            material and that no third party ownership rights exist to any
            material submitted, and (4) you are hereby granting the Company a
            perpetual, worldwide, non-exclusive, royalty-free, sub-licensable
            (through multiple tiers) right and license to use, publish,
            reproduce, display, perform, adapt, modify, distribute, have
            distributed and promote such content in any form, in all media now
            known or hereinafter created, anywhere in the world, for any
            purpose.
          </Text>
          <Text style={styles.paragraph}>
            Miscellaneous. Void where prohibited. Each winner must submit proof
            of eligibility to claim the prize.
          </Text>
          ...
          <Text style={styles.paragraph}>
            ...
            that are not owned or controlled by Futurice Oy.
          </Text>
          <Text style={styles.paragraph}>
            Futurice Oy has no control over, and assumes no responsibility for,
            the content, privacy policies, or practices of any third party web
            sites or services. You further acknowledge and agree that Futurice
            Oy shall not be responsible or liable, directly or indirectly, for
          ...
          <Text style={styles.paragraph}>
            In no event shall Futurice Oy, nor its directors, employees,
          ...
          <Text style={styles.paragraph}>
            Futurice Oy its subsidiaries, affiliates, and its licensors do not
          ...
          <Text style={styles.paragraph}>
            ...
            these Terms at any time. Changes to these Terms of Service shall
            enter into force after they have been published on this site.
          </Text>
          <Text style={styles.paragraph}>
          ...
          <Text style={styles.paragraph}>
            ...
            email futubileet@futurice.com. Postal address: Kelloportinkatu 1 D,
            33100 Tampere.
          </Text>
        </View>
      </ScrollView>
